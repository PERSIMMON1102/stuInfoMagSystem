...
public class MessageConstant {
    ...
    public static final String SELECTED_DATE_CANNOT_ORDER = "所选日期未开放";
    ...
    public static final String DO_CHECKGROUP_SUCCESS = "检查组信息操作成功";
    public static final String DO_CHECKGROUP_FAIL = "检查组信息操作失败";
    public static final String DELETE_SETMEAL_SUCCESS = "删除套餐成功";
    public static final String DELETE_SETMEAL_FAIL = "删除套餐失败";
    public static final String FILE_CONTENT_NO_NULL = "上传文件内容不能为空";
